...
func transportForEntry(ctx context.Context, entry config.MCPServerEntry, httpClient *http.Client) (mcp.Transport, error) {
	...
	case "stdio":
		...
		cmd.Env = config.MergedProcessEnv(entry.Env)
